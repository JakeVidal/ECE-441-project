...
constant COUNT_MAX : integer := 1;   -- number of clocks to delay to get past bouncing periods (default is 7500000)
signal count : integer       := 0;   -- the counter to implement the delays.  10 to 12ms is typical. 10000000=10ms (default is 7500000), set to 0 for simulation

...
begin
	if(reset = '1') then
		...
		if(refresh_display_counter >= x"000001F") then -- correct counter value is x"000BC1F, x"000001F" for simulations."
			refresh_display_counter <= x"0000000";
...
refresh_period_reached <= '1' when refresh_display_counter = x"000001F" else '0'; -- correct counter value is x"000BC1F, x"000001F" for simulations."
